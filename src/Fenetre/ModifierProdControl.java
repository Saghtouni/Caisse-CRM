...
public class ModifierProdControl extends BorderPane  implements Initializable{
    ...
    void bntModifierClicked(ActionEvent event) {
    	produitsDB.update(produitsCot.getIdProduit(), textReference.getText(), textNom.getText(), Double.parseDouble(textPrixA.getText()), Double.parseDouble(textPrixV.getText()), textType.getText(),Integer.parseInt(textQuantite.getText()), textFornisseur.getText(), Double.parseDouble(textTVA.getText()), textImage.getText(), textUnit.getText(), code_bare.getText());
    ...
    public void initialize(URL location, ResourceBundle resources) {
       produit = produitsDB.get(produitsCot.getIdProduit());
        ...
        textUnit.setText(produit.getUnit());
        //code_bare.setText(produit.getCode_bare());
        if(produit.getImage() != null)
        imageProduits.setImage(new Image(produit.getImage()));
        
    	System.out.println(produitsCot.getIdProduit());
        bntJoindre();
    }
}
