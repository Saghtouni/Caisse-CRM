...
public class EnregisterProControl extends BorderPane implements Initializable{
    ...
    void bntEnregisterClicked(ActionEvent event) {
    	...
    	produitsDB.add(testReference.getText(), testNom.getText() , prix, Double.parseDouble(textPrixV.getText()), tesxtType.getText(), Integer.parseInt(textQuantite.getText()),   textFornisseur.getText() ,Double.parseDouble(textTVA.getText()), image,uniteText.getText(), code_bare.getText());
