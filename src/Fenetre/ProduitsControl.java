...
public class ProduitsControl extends BorderPane implements Initializable {
	private Connection DB = null;
	    ...
	    @FXML
	    private TableColumn<Produits, String> ColumnUNIT;
	    
	    @FXML
	    private TextField TexteUnit;
	    ...
	    void MouseClicked(MouseEvent event) {
	    	if(event.getButton().equals(MouseButton.PRIMARY)) {
	    		...
	    		TexteUnit.setText(TableProduits.getSelectionModel().getSelectedItem().getUnit()+"");
	    ...
	    public void initialize(URL arg0, ResourceBundle arg1) {
	    	...
	    	//ColumnQantite.setCellValueFactory(new PropertyValueFactory("QNT"));
